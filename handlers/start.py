...
speakers = [
    'Анастасия Федорова, директор по продуктам вертикалей Недвижимость',
...
async def start(message: Message):
    ...
    await message.answer_document(document=open('document.pdf', 'rb'),
                                  caption='Продолжая пользоваться чат-ботом,  Ты подтверждаешь, что ознакомлен и согласен с Политикой конфиденциальности',
